...
wd = '/Users/songweizhi/Desktop/FC_000'
...
SNV_matrix_cdc = 'SNV_QC_even_depth_matrix_210_frequency_cdc.txt'
transl_table = 11
...
# report
print('The total number of affected genes: %s' % len(mutation_cate_dict))
