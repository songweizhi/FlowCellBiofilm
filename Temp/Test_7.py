...
# input files
wd = '/Users/songweizhi/Desktop/MapHGT/wd_1HGT'
refseq_file = 'combined_ref.fasta'
sam_in = 'combined_ref.sam'

# wd = '/Users/songweizhi/Desktop/MapHGT/wd_m0'
# refseq_file = 'combined_mNC.fasta'
# sam_in = 'combined_m0.sam'
...
for each_ref in refseq_id_list:
    ...
    n = 0
    break_points_uniq_remove_low = []
    break_points_uniq_count_remove_low = []
    while n < len(break_points_uniq):
        if break_points_uniq_count[n] > min_count:
            break_points_uniq_remove_low.append(break_points_uniq[n])
            break_points_uniq_count_remove_low.append(break_points_uniq_count[n])
        n += 1


    print(each_ref)
    print(break_points_uniq_remove_low)
