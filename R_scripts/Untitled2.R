...
#snv_factor_file
snv_summary = read.delim('deepSNV_output_summary_210_existence_cdc_D9.txt', row.names=1)
snv_summary
snv_factor = read.delim('deepSNV_output_summary_210_factor_D9.txt', row.names=1)
snv_factor
# Import data
